...
namespace olive.BusinessObject
{
    public partial class InvoiceReport : BaseBusiness
    {
        ...
        private OracleDataAdapter detail2Adapter = new OracleDataAdapter("select * from v_invoicedetail2_report where fp001 = :fp001", SqlAssist.conn);
        ...
        public InvoiceReport()
        {
            ...
            detail2Adapter.SelectCommand.Parameters.AddRange(new OracleParameter[] { op_fp001 });
		...
		private void gridView3_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
		{
            ...
            if (rowHandle >= 0)
            {
                ...
                op_fp001.Value = s_fp001;
                detail2Adapter.Fill(dt_detail2);
