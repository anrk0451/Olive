namespace olive.BusinessObject
{
    partial class FinanceDaySearch
    {
        ...
        private void InitializeComponent()
        {
			...
			this.colFA004 = new DevExpress.XtraGrid.Columns.GridColumn();
			...
			this.colFA001 = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colFA002 = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colAC001 = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colFA003 = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colFA180 = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colFA190 = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colFA100 = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colHANDLER = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colFA200 = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colWS001 = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colINVNUM = new DevExpress.XtraGrid.Columns.GridColumn();
			...
			// colFA004
			// 
			this.colFA004.Caption = "收费金额";
			this.colFA004.DisplayFormat.FormatString = "N2";
			this.colFA004.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
			this.colFA004.FieldName = "FA004";
			this.colFA004.MinWidth = 25;
			this.colFA004.Name = "colFA004";
			this.colFA004.Summary.AddRange(new DevExpress.XtraGrid.GridSummaryItem[] {
            new DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "FA004", "合计={0:N2}")});
			this.colFA004.Visible = true;
			this.colFA004.VisibleIndex = 5;
			this.colFA004.Width = 131;
			// 
			// barManager1
			// 
            ...
            new DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.PaintStyle, this.barButtonItem31, DevExpress.XtraBars.BarItemPaintStyle.CaptionGlyph),
			...
			// barSubItem4
			// 
			this.barSubItem4.Caption = "打印";
			this.barSubItem4.Id = 37;
			this.barSubItem4.ImageOptions.SvgImage = global::olive.Properties.Resources.defaultprinter;
			...
			// barButtonItem20
			// 
			this.barButtonItem20.Caption = "税务发票";
			...
			// barButtonItem30
			// 
			this.barButtonItem30.Caption = "税票清单";
			...
			// barButtonItem31
			// 
			this.barButtonItem31.Caption = "日志维护";
			this.barButtonItem31.Id = 40;
			this.barButtonItem31.ImageOptions.SvgImage = global::olive.Properties.Resources.bo_security_permission_model;
			...
			this.toggle_onlyme.Id = 41;
			this.toggle_onlyme.Name = "toggle_onlyme";
			toolTipItem1.Text = "只看自己";
			...
			this.barDockControlTop.Size = new System.Drawing.Size(1331, 34);
			// 
			...
			this.barDockControlRight.Location = new System.Drawing.Point(1331, 34);
			...
			this.xpCollection1.ObjectType = typeof(olive.xpo.orcl.V_FA01_SEARCH);
			...
			this.splitContainerControl1.Size = new System.Drawing.Size(1331, 683);
			...
			this.gridControl1.Size = new System.Drawing.Size(1331, 469);
            ...
            this.gridColumn1,
            this.gridColumn2});
			gridFormatRule1.Column = this.colFA004;
			...
			// colFA001
			// 
			this.colFA001.Caption = "结算流水号";
			this.colFA001.FieldName = "FA001";
			this.colFA001.MinWidth = 25;
			this.colFA001.Name = "colFA001";
			this.colFA001.Summary.AddRange(new DevExpress.XtraGrid.GridSummaryItem[] {
            new DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Count, "FA001", "共计{0}笔")});
			this.colFA001.Visible = true;
			this.colFA001.VisibleIndex = 0;
			this.colFA001.Width = 114;
			// 
			// colFA002
			// 
			this.colFA002.Caption = "结算类型";
			this.colFA002.FieldName = "FA002";
			this.colFA002.MinWidth = 25;
			this.colFA002.Name = "colFA002";
			this.colFA002.Visible = true;
			this.colFA002.VisibleIndex = 1;
			this.colFA002.Width = 94;
			// 
			// colAC001
			// 
			this.colAC001.Caption = "购墓流水号";
			this.colAC001.FieldName = "AC001";
			this.colAC001.MinWidth = 25;
			this.colAC001.Name = "colAC001";
			this.colAC001.Visible = true;
			this.colAC001.VisibleIndex = 2;
			this.colAC001.Width = 110;
			// 
			// colFA003
			// 
			this.colFA003.Caption = "交款人";
			this.colFA003.FieldName = "FA003";
			this.colFA003.MinWidth = 25;
			this.colFA003.Name = "colFA003";
			this.colFA003.Visible = true;
			this.colFA003.VisibleIndex = 4;
			this.colFA003.Width = 121;
			// 
			// colFA180
			// 
			this.colFA180.Caption = "备注";
			this.colFA180.FieldName = "FA180";
			this.colFA180.MinWidth = 25;
			this.colFA180.Name = "colFA180";
			this.colFA180.OptionsColumn.AllowShowHide = false;
			this.colFA180.Width = 274;
			// 
			// colFA190
			// 
			this.colFA190.Caption = "开票标志";
			this.colFA190.FieldName = "FA190";
			this.colFA190.MinWidth = 25;
			this.colFA190.Name = "colFA190";
			this.colFA190.Visible = true;
			this.colFA190.VisibleIndex = 6;
			this.colFA190.Width = 99;
			// 
			// colFA100
			// 
			this.colFA100.FieldName = "FA100";
			this.colFA100.MinWidth = 25;
			this.colFA100.Name = "colFA100";
			this.colFA100.OptionsColumn.AllowShowHide = false;
			this.colFA100.Width = 94;
			// 
			// colHANDLER
			// 
			...
			this.colHANDLER.VisibleIndex = 8;
			this.colHANDLER.Width = 94;
			// 
			// colFA200
			// 
			this.colFA200.Caption = "收费日期";
			this.colFA200.FieldName = "FA200";
			this.colFA200.MinWidth = 25;
			this.colFA200.Name = "colFA200";
			this.colFA200.Visible = true;
			this.colFA200.VisibleIndex = 9;
			this.colFA200.Width = 98;
			// 
			// colWS001
			// 
			this.colWS001.Caption = "工作站标识";
			this.colWS001.FieldName = "WS001";
			this.colWS001.MinWidth = 25;
			this.colWS001.Name = "colWS001";
			this.colWS001.OptionsColumn.AllowShowHide = false;
			this.colWS001.Width = 162;
			// 
			// colINVNUM
			// 
			this.colINVNUM.Caption = "发票号";
			this.colINVNUM.ColumnEdit = this.repositoryItemHyperLinkEdit1;
			this.colINVNUM.FieldName = "INVNUM";
			this.colINVNUM.MinWidth = 25;
			this.colINVNUM.Name = "colINVNUM";
			this.colINVNUM.Visible = true;
			this.colINVNUM.VisibleIndex = 7;
			this.colINVNUM.Width = 277;
			// 
			...
			// gridColumn1
			// 
			this.gridColumn1.Caption = "收费工作站";
			this.gridColumn1.FieldName = "WS003";
			...
			this.gridControl2.Size = new System.Drawing.Size(1331, 202);
			...
			this.Size = new System.Drawing.Size(1331, 717);
        ...
        private DevExpress.XtraGrid.Columns.GridColumn colFA001;
        private DevExpress.XtraGrid.Columns.GridColumn colFA002;
        private DevExpress.XtraGrid.Columns.GridColumn colAC001;
        private DevExpress.XtraGrid.Columns.GridColumn colFA003;
        private DevExpress.XtraGrid.Columns.GridColumn colFA004;
        private DevExpress.XtraGrid.Columns.GridColumn colFA180;
        private DevExpress.XtraGrid.Columns.GridColumn colFA190;
        private DevExpress.XtraGrid.Columns.GridColumn colFA100;
        private DevExpress.XtraGrid.Columns.GridColumn colHANDLER;
        private DevExpress.XtraGrid.Columns.GridColumn colFA200;
        private DevExpress.XtraGrid.Columns.GridColumn colWS001;
        private DevExpress.XtraGrid.Columns.GridColumn colINVNUM;
