namespace olive.BusinessObject
{
	partial class Report_TombStat
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Report_TombStat));
			...
			// gridColumn1
			// 
			this.gridColumn1.Caption = "墓区";
			this.gridColumn1.FieldName = "RG003";
			...
			// gridColumn3
			// 
			this.gridColumn3.Caption = "购墓人";
			this.gridColumn3.FieldName = "AC003";
			...
			this.gridColumn4.FieldName = "AC022";
			...
			// gridColumn5
			// 
			this.gridColumn5.Caption = "购墓日期";
			this.gridColumn5.FieldName = "AC049";
			...
			this.Name = "Report_TombStat";
			this.Load += new System.EventHandler(this.Report_TombStat_Load);
