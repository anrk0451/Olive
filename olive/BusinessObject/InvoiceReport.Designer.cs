namespace olive.BusinessObject
{
    partial class InvoiceReport
    {
        ...
        private void InitializeComponent()
        {
			...
			this.bi_begin = new DevExpress.XtraBars.BarEditItem();
			this.repositoryItemDateEdit1 = new DevExpress.XtraEditors.Repository.RepositoryItemDateEdit();
			this.barStaticItem3 = new DevExpress.XtraBars.BarStaticItem();
			this.bi_end = new DevExpress.XtraBars.BarEditItem();
			this.repositoryItemDateEdit2 = new DevExpress.XtraEditors.Repository.RepositoryItemDateEdit();
			this.barButtonItem30 = new DevExpress.XtraBars.BarButtonItem();
			this.bi_only = new DevExpress.XtraBars.BarEditItem();
			...
			this.lc_fs_je = new DevExpress.XtraEditors.LabelControl();
			this.labelControl17 = new DevExpress.XtraEditors.LabelControl();
			this.labelControl18 = new DevExpress.XtraEditors.LabelControl();
			this.lc_fs_ps = new DevExpress.XtraEditors.LabelControl();
			this.labelControl20 = new DevExpress.XtraEditors.LabelControl();
			this.lc_zs_je = new DevExpress.XtraEditors.LabelControl();
			this.labelControl15 = new DevExpress.XtraEditors.LabelControl();
			this.labelControl13 = new DevExpress.XtraEditors.LabelControl();
			this.lc_zs_ps = new DevExpress.XtraEditors.LabelControl();
			this.labelControl11 = new DevExpress.XtraEditors.LabelControl();
			this.lc_zf_je = new DevExpress.XtraEditors.LabelControl();
			this.labelControl10 = new DevExpress.XtraEditors.LabelControl();
			this.labelControl8 = new DevExpress.XtraEditors.LabelControl();
			this.lc_zf_ps = new DevExpress.XtraEditors.LabelControl();
			this.labelControl6 = new DevExpress.XtraEditors.LabelControl();
			this.labelControl5 = new DevExpress.XtraEditors.LabelControl();
			this.lc_total_je = new DevExpress.XtraEditors.LabelControl();
			this.labelControl3 = new DevExpress.XtraEditors.LabelControl();
			this.lc_total_ps = new DevExpress.XtraEditors.LabelControl();
			...
			this.gridColumn_jshj = new DevExpress.XtraGrid.Columns.GridColumn();
			...
			this.gridColumn_jshj2 = new DevExpress.XtraGrid.Columns.GridColumn();
			...
			this.gridColumn_jshj3 = new DevExpress.XtraGrid.Columns.GridColumn();
            ...
            new DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.Width, this.bi_begin, "", false, true, true, 106),
            new DevExpress.XtraBars.LinkPersistInfo(this.barStaticItem3),
            new DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.Width, this.bi_end, "", false, true, true, 106),
            new DevExpress.XtraBars.LinkPersistInfo(this.barButtonItem30),
            new DevExpress.XtraBars.LinkPersistInfo(this.bi_only),
            ...
            new DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.PaintStyle, this.barButtonItem29, DevExpress.XtraBars.BarItemPaintStyle.CaptionGlyph),
            new DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.PaintStyle, this.barButtonItem28, DevExpress.XtraBars.BarItemPaintStyle.CaptionGlyph)});
			...
			// barHeaderItem1
			// 
			this.barHeaderItem1.Caption = "统计区间";
			this.barHeaderItem1.Id = 44;
			this.barHeaderItem1.Name = "barHeaderItem1";
			// 
			// bi_begin
			// 
			this.bi_begin.Caption = "barEditItem2";
			this.bi_begin.Edit = this.repositoryItemDateEdit1;
			this.bi_begin.Id = 41;
			this.bi_begin.Name = "bi_begin";
			// 
			...
			// barStaticItem3
			// 
			this.barStaticItem3.Caption = "至";
			this.barStaticItem3.Id = 42;
			this.barStaticItem3.Name = "barStaticItem3";
			// 
			// bi_end
			// 
			this.bi_end.Caption = "barEditItem3";
			this.bi_end.Edit = this.repositoryItemDateEdit2;
			this.bi_end.Id = 43;
			this.bi_end.Name = "bi_end";
			// 
			...
			// barButtonItem30
			// 
			this.barButtonItem30.Id = 45;
			this.barButtonItem30.ImageOptions.Image = global::olive.Properties.Resources.media_16x16;
			this.barButtonItem30.ImageOptions.LargeImage = global::olive.Properties.Resources.media_32x32;
			this.barButtonItem30.Name = "barButtonItem30";
			toolTipItem1.Text = "执行";
			superToolTip1.Items.Add(toolTipItem1);
			this.barButtonItem30.SuperTip = superToolTip1;
			this.barButtonItem30.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItem30_ItemClick);
			// 
			// bi_only
			// 
			this.bi_only.Caption = "只看自己";
			this.bi_only.CaptionAlignment = DevExpress.Utils.HorzAlignment.Near;
			this.bi_only.Edit = this.repositoryItemToggleSwitch1;
			this.bi_only.Id = 47;
			this.bi_only.Name = "bi_only";
			this.bi_only.EditValueChanged += new System.EventHandler(this.bi_only_EditValueChanged);
			// 
			...
			// barButtonItem29
			// 
			this.barButtonItem29.Caption = "查找";
			...
			this.barDockControlTop.Size = new System.Drawing.Size(1646, 34);
			// 
			...
			this.barDockControlBottom.Size = new System.Drawing.Size(1646, 0);
			// 
			// barDockControlLeft
			// 
			...
			this.barDockControlRight.Location = new System.Drawing.Point(1646, 34);
			...
			// barButtonItem10
			// 
			this.barButtonItem10.Caption = "查询条件";
			...
			// barStaticItem2
			// 
			this.barStaticItem2.Caption = "统计区间";
			this.barStaticItem2.Id = 38;
			this.barStaticItem2.Name = "barStaticItem2";
			// 
			// barListItem1
			// 
			this.barListItem1.Caption = "统计区间";
			...
			this.barEditItem2.Edit = this.repositoryItemTextEdit9;
			this.barEditItem2.Id = 46;
			...
			// panelControl1
			// 
			this.panelControl1.Controls.Add(this.lc_fs_je);
			this.panelControl1.Controls.Add(this.labelControl17);
			this.panelControl1.Controls.Add(this.labelControl18);
			this.panelControl1.Controls.Add(this.lc_fs_ps);
			this.panelControl1.Controls.Add(this.labelControl20);
			this.panelControl1.Controls.Add(this.lc_zs_je);
			this.panelControl1.Controls.Add(this.labelControl15);
			this.panelControl1.Controls.Add(this.labelControl13);
			this.panelControl1.Controls.Add(this.lc_zs_ps);
			this.panelControl1.Controls.Add(this.labelControl11);
			this.panelControl1.Controls.Add(this.lc_zf_je);
			this.panelControl1.Controls.Add(this.labelControl10);
			this.panelControl1.Controls.Add(this.labelControl8);
			this.panelControl1.Controls.Add(this.lc_zf_ps);
			this.panelControl1.Controls.Add(this.labelControl6);
			this.panelControl1.Controls.Add(this.labelControl5);
			this.panelControl1.Controls.Add(this.lc_total_je);
			this.panelControl1.Controls.Add(this.labelControl3);
			this.panelControl1.Controls.Add(this.lc_total_ps);
			this.panelControl1.Controls.Add(this.labelControl1);
			this.panelControl1.Dock = System.Windows.Forms.DockStyle.Top;
			this.panelControl1.Location = new System.Drawing.Point(0, 34);
			this.panelControl1.Name = "panelControl1";
			this.panelControl1.Size = new System.Drawing.Size(1646, 129);
			this.panelControl1.TabIndex = 4;
			// 
			// lc_fs_je
			// 
			this.lc_fs_je.Appearance.Image = null;
			this.lc_fs_je.AppearanceDisabled.Image = null;
			this.lc_fs_je.AppearanceHovered.Image = null;
			this.lc_fs_je.AppearancePressed.Image = null;
			this.lc_fs_je.Location = new System.Drawing.Point(716, 75);
			this.lc_fs_je.Name = "lc_fs_je";
			this.lc_fs_je.Size = new System.Drawing.Size(9, 21);
			this.lc_fs_je.TabIndex = 19;
			this.lc_fs_je.Text = "0";
			// 
			// labelControl17
			// 
			...
			this.labelControl17.Location = new System.Drawing.Point(623, 75);
			this.labelControl17.Name = "labelControl17";
			this.labelControl17.Size = new System.Drawing.Size(72, 22);
			this.labelControl17.TabIndex = 18;
			this.labelControl17.Text = "开票金额";
			// 
			// labelControl18
			// 
			...
			this.labelControl18.Location = new System.Drawing.Point(564, 75);
			this.labelControl18.Name = "labelControl18";
			this.labelControl18.Size = new System.Drawing.Size(18, 22);
			this.labelControl18.TabIndex = 17;
			this.labelControl18.Text = "张";
			// 
			// lc_fs_ps
			// 
			this.lc_fs_ps.Appearance.Image = null;
			this.lc_fs_ps.AppearanceDisabled.Image = null;
			this.lc_fs_ps.AppearanceHovered.Image = null;
			this.lc_fs_ps.AppearancePressed.Image = null;
			this.lc_fs_ps.Location = new System.Drawing.Point(531, 75);
			this.lc_fs_ps.Name = "lc_fs_ps";
			this.lc_fs_ps.Size = new System.Drawing.Size(9, 21);
			this.lc_fs_ps.TabIndex = 16;
			this.lc_fs_ps.Text = "0";
			// 
			// labelControl20
			// 
			...
			this.labelControl20.Location = new System.Drawing.Point(453, 75);
			this.labelControl20.Name = "labelControl20";
			this.labelControl20.Size = new System.Drawing.Size(72, 22);
			this.labelControl20.TabIndex = 15;
			this.labelControl20.Text = "负数发票";
			// 
			// lc_zs_je
			// 
			this.lc_zs_je.Appearance.Image = null;
			this.lc_zs_je.AppearanceDisabled.Image = null;
			this.lc_zs_je.AppearanceHovered.Image = null;
			this.lc_zs_je.AppearancePressed.Image = null;
			this.lc_zs_je.Location = new System.Drawing.Point(299, 75);
			this.lc_zs_je.Name = "lc_zs_je";
			this.lc_zs_je.Size = new System.Drawing.Size(9, 21);
			this.lc_zs_je.TabIndex = 14;
			this.lc_zs_je.Text = "0";
			// 
			// labelControl15
			// 
			...
			this.labelControl15.Location = new System.Drawing.Point(210, 75);
			this.labelControl15.Name = "labelControl15";
			this.labelControl15.Size = new System.Drawing.Size(72, 22);
			this.labelControl15.TabIndex = 13;
			this.labelControl15.Text = "开票金额";
			// 
			// labelControl13
			// 
			...
			this.labelControl13.Location = new System.Drawing.Point(183, 75);
			this.labelControl13.Name = "labelControl13";
			this.labelControl13.Size = new System.Drawing.Size(18, 22);
			this.labelControl13.TabIndex = 12;
			this.labelControl13.Text = "张";
			// 
			// lc_zs_ps
			// 
			this.lc_zs_ps.Appearance.Image = null;
			this.lc_zs_ps.AppearanceDisabled.Image = null;
			this.lc_zs_ps.AppearanceHovered.Image = null;
			this.lc_zs_ps.AppearancePressed.Image = null;
			this.lc_zs_ps.Location = new System.Drawing.Point(150, 75);
			this.lc_zs_ps.Name = "lc_zs_ps";
			this.lc_zs_ps.Size = new System.Drawing.Size(9, 21);
			this.lc_zs_ps.TabIndex = 11;
			this.lc_zs_ps.Text = "0";
			// 
			// labelControl11
			// 
			...
			this.labelControl11.Location = new System.Drawing.Point(36, 75);
			this.labelControl11.Name = "labelControl11";
			this.labelControl11.Size = new System.Drawing.Size(108, 22);
			this.labelControl11.TabIndex = 10;
			this.labelControl11.Text = "其中正数发票";
			// 
			// lc_zf_je
			// 
			this.lc_zf_je.Appearance.Image = null;
			this.lc_zf_je.AppearanceDisabled.Image = null;
			this.lc_zf_je.AppearanceHovered.Image = null;
			this.lc_zf_je.AppearancePressed.Image = null;
			this.lc_zf_je.Location = new System.Drawing.Point(715, 31);
			this.lc_zf_je.Name = "lc_zf_je";
			this.lc_zf_je.Size = new System.Drawing.Size(9, 21);
			this.lc_zf_je.TabIndex = 9;
			this.lc_zf_je.Text = "0";
			// 
			// labelControl10
			// 
			...
			this.labelControl10.Location = new System.Drawing.Point(623, 31);
			this.labelControl10.Name = "labelControl10";
			this.labelControl10.Size = new System.Drawing.Size(72, 22);
			this.labelControl10.TabIndex = 8;
			this.labelControl10.Text = "作废金额";
			// 
			// labelControl8
			// 
			...
			this.labelControl8.Location = new System.Drawing.Point(564, 31);
			this.labelControl8.Name = "labelControl8";
			this.labelControl8.Size = new System.Drawing.Size(18, 22);
			this.labelControl8.TabIndex = 7;
			this.labelControl8.Text = "张";
			// 
			// lc_zf_ps
			// 
			this.lc_zf_ps.Appearance.Image = null;
			this.lc_zf_ps.AppearanceDisabled.Image = null;
			this.lc_zf_ps.AppearanceHovered.Image = null;
			this.lc_zf_ps.AppearancePressed.Image = null;
			this.lc_zf_ps.Location = new System.Drawing.Point(531, 31);
			this.lc_zf_ps.Name = "lc_zf_ps";
			this.lc_zf_ps.Size = new System.Drawing.Size(9, 21);
			this.lc_zf_ps.TabIndex = 6;
			this.lc_zf_ps.Text = "0";
			// 
			// labelControl6
			// 
			...
			this.labelControl6.Location = new System.Drawing.Point(453, 31);
			this.labelControl6.Name = "labelControl6";
			this.labelControl6.Size = new System.Drawing.Size(72, 22);
			this.labelControl6.TabIndex = 5;
			this.labelControl6.Text = "作废发票";
			// 
			// labelControl5
			// 
			...
			this.labelControl5.Location = new System.Drawing.Point(166, 31);
			this.labelControl5.Name = "labelControl5";
			this.labelControl5.Size = new System.Drawing.Size(18, 22);
			this.labelControl5.TabIndex = 4;
			this.labelControl5.Text = "张";
			// 
			// lc_total_je
			// 
			this.lc_total_je.Appearance.Image = null;
			this.lc_total_je.AppearanceDisabled.Image = null;
			this.lc_total_je.AppearanceHovered.Image = null;
			this.lc_total_je.AppearancePressed.Image = null;
			this.lc_total_je.Location = new System.Drawing.Point(299, 31);
			this.lc_total_je.Name = "lc_total_je";
			this.lc_total_je.Size = new System.Drawing.Size(9, 21);
			this.lc_total_je.TabIndex = 3;
			this.lc_total_je.Text = "0";
			// 
			// labelControl3
			// 
			...
			this.labelControl3.Location = new System.Drawing.Point(210, 31);
			this.labelControl3.Name = "labelControl3";
			this.labelControl3.Size = new System.Drawing.Size(72, 22);
			this.labelControl3.TabIndex = 2;
			this.labelControl3.Text = "开票金额";
			// 
			// lc_total_ps
			// 
			this.lc_total_ps.Appearance.Image = null;
			this.lc_total_ps.AppearanceDisabled.Image = null;
			this.lc_total_ps.AppearanceHovered.Image = null;
			this.lc_total_ps.AppearancePressed.Image = null;
			this.lc_total_ps.Location = new System.Drawing.Point(133, 31);
			this.lc_total_ps.Name = "lc_total_ps";
			this.lc_total_ps.Size = new System.Drawing.Size(9, 21);
			this.lc_total_ps.TabIndex = 1;
			this.lc_total_ps.Text = "0";
			// 
			// labelControl1
			// 
			...
			this.splitContainerControl1.Size = new System.Drawing.Size(1646, 427);
			this.splitContainerControl1.SplitterPosition = 1041;
			...
			this.xtraTabControl1.Size = new System.Drawing.Size(1041, 427);
			...
			this.xtraTabPage1.Size = new System.Drawing.Size(1039, 393);
			this.xtraTabPage1.Text = "正数发票";
			// 
			// gridControl1
			// 
			...
			this.gridControl1.Size = new System.Drawing.Size(1039, 393);
			...
			// gridColumn1
			// 
			this.gridColumn1.Caption = "发票代码";
			this.gridColumn1.FieldName = "INVOICECODE";
			...
			this.gridColumn2.FieldName = "INVOICENUM";
			...
			// gridColumn3
			// 
			this.gridColumn3.Caption = "购方名称";
			this.gridColumn3.FieldName = "INFOCLIENTNAME";
			...
			// gridColumn_jshj
			// 
			this.gridColumn_jshj.Caption = "价税合计金额";
			this.gridColumn_jshj.DisplayFormat.FormatString = "N2";
			this.gridColumn_jshj.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
			this.gridColumn_jshj.FieldName = "JSHJ";
			this.gridColumn_jshj.MinWidth = 25;
			this.gridColumn_jshj.Name = "gridColumn_jshj";
			this.gridColumn_jshj.Visible = true;
			this.gridColumn_jshj.VisibleIndex = 3;
			this.gridColumn_jshj.Width = 137;
			// 
			// gridColumn5
			// 
			...
			// gridColumn6
			// 
			this.gridColumn6.Caption = "开票工作站";
			this.gridColumn6.FieldName = "WS003";
			...
			// gridColumn25
			// 
			this.gridColumn25.Caption = "开票人";
			this.gridColumn25.FieldName = "KPR";
			...
			this.gridColumn10.FieldName = "FP001";
			...
			this.xtraTabPage2.Size = new System.Drawing.Size(1039, 393);
			this.xtraTabPage2.Text = "负数发票";
			// 
			// gridControl2
			// 
			...
			this.gridControl2.Size = new System.Drawing.Size(1039, 393);
			...
			// gridView2
			// 
			this.gridView2.Appearance.FooterPanel.Font = new System.Drawing.Font("Tahoma", 10.8F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			...
			// gridColumn7
			// 
			this.gridColumn7.Caption = "发票代码";
			this.gridColumn7.FieldName = "INVOICECODE";
			...
			// gridColumn8
			// 
			this.gridColumn8.Caption = "发票号";
			this.gridColumn8.FieldName = "INVOICENUM";
			...
			// gridColumn9
			// 
			this.gridColumn9.Caption = "购方名称";
			this.gridColumn9.FieldName = "INFOCLIENTNAME";
			...
			// gridColumn_jshj2
			// 
			this.gridColumn_jshj2.Caption = "价税合计金额";
			this.gridColumn_jshj2.DisplayFormat.FormatString = "N2";
			this.gridColumn_jshj2.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
			this.gridColumn_jshj2.FieldName = "JSHJ";
			this.gridColumn_jshj2.MinWidth = 25;
			this.gridColumn_jshj2.Name = "gridColumn_jshj2";
			this.gridColumn_jshj2.Visible = true;
			this.gridColumn_jshj2.VisibleIndex = 3;
			this.gridColumn_jshj2.Width = 140;
			// 
			// gridColumn11
			// 
			this.gridColumn11.Caption = "开票日期";
			...
			this.gridColumn11.FieldName = "INVOICEDATE";
			...
			// gridColumn12
			// 
			this.gridColumn12.Caption = "开票工作站";
			this.gridColumn12.FieldName = "WS003";
			...
			this.gridColumn16.FieldName = "FP001";
			...
			this.xtraTabPage3.Size = new System.Drawing.Size(1039, 393);
			this.xtraTabPage3.Text = "作废发票";
			// 
			// gridControl3
			// 
			...
			this.gridControl3.Size = new System.Drawing.Size(1039, 393);
			...
			// gridView3
			// 
			this.gridView3.Appearance.FooterPanel.Font = new System.Drawing.Font("Tahoma", 10.8F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			...
			this.gridView3.Appearance.GroupFooter.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Far;
			...
			this.gridView3.Appearance.HeaderPanel.Options.UseImage = true;
			...
			// gridColumn13
			// 
			this.gridColumn13.Caption = "发票代码";
			this.gridColumn13.FieldName = "INVOICECODE";
			...
			// gridColumn14
			// 
			this.gridColumn14.Caption = "发票号";
			this.gridColumn14.FieldName = "INVOICENUM";
			...
			// gridColumn15
			// 
			this.gridColumn15.Caption = "购方名称";
			this.gridColumn15.FieldName = "INFOCLIENTNAME";
			this.gridColumn15.MinWidth = 25;
			this.gridColumn15.Name = "gridColumn15";
			this.gridColumn15.Visible = true;
			this.gridColumn15.VisibleIndex = 2;
			this.gridColumn15.Width = 202;
			// 
			// gridColumn_jshj3
			// 
			this.gridColumn_jshj3.Caption = "价税合计金额";
			this.gridColumn_jshj3.DisplayFormat.FormatString = "N2";
			this.gridColumn_jshj3.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
			this.gridColumn_jshj3.FieldName = "JSHJ";
			this.gridColumn_jshj3.MinWidth = 25;
			this.gridColumn_jshj3.Name = "gridColumn_jshj3";
			this.gridColumn_jshj3.Visible = true;
			this.gridColumn_jshj3.VisibleIndex = 3;
			this.gridColumn_jshj3.Width = 140;
			// 
			// gridColumn17
			// 
			this.gridColumn17.Caption = "开票日期";
			...
			this.gridColumn17.FieldName = "INVOICEDATE";
			...
			// gridColumn18
			// 
			this.gridColumn18.Caption = "开票工作站";
			this.gridColumn18.FieldName = "WS003";
			...
			// gridColumn4
			// 
			this.gridColumn4.Caption = "作废日期";
			this.gridColumn4.DisplayFormat.FormatString = "d";
			this.gridColumn4.DisplayFormat.FormatType = DevExpress.Utils.FormatType.DateTime;
			this.gridColumn4.FieldName = "ZFDATE";
			...
			this.gridColumn26.FieldName = "FP001";
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.repositoryItemLookUpEdit2.DisplayMember = "UC003";
			this.repositoryItemLookUpEdit2.Name = "repositoryItemLookUpEdit2";
			this.repositoryItemLookUpEdit2.NullText = "";
			this.repositoryItemLookUpEdit2.ValueMember = "UC001";
			// 
			...
			this.gridControl4.Size = new System.Drawing.Size(593, 427);
			this.gridControl4.TabIndex = 31;
			this.gridControl4.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {
            this.gridView4});
			// 
			// gridView4
			// 
			this.gridView4.Appearance.FooterPanel.Font = new System.Drawing.Font("Tahoma", 10.8F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			...
			this.gridView4.Appearance.FooterPanel.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Far;
			this.gridView4.Appearance.GroupFooter.Options.UseTextOptions = true;
			this.gridView4.Appearance.GroupFooter.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Far;
			this.gridView4.Appearance.HeaderPanel.Font = new System.Drawing.Font("Tahoma", 10.8F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			...
			this.gridView4.Appearance.HeaderPanel.Options.UseImage = true;
			...
			this.gridColumn19.FieldName = "SA003";
			this.gridColumn19.MinWidth = 25;
			this.gridColumn19.Name = "gridColumn19";
			this.gridColumn19.Visible = true;
			this.gridColumn19.VisibleIndex = 0;
			this.gridColumn19.Width = 169;
			// 
			// gridColumn20
			// 
			this.gridColumn20.Caption = "价格";
			...
			this.gridColumn21.DisplayFormat.FormatString = "N1";
			this.gridColumn21.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
			this.gridColumn21.FieldName = "NUMS";
			...
			this.gridColumn22.FieldName = "SA007";
			...
			this.gridColumn23.FieldName = "FP001";
			...
			this.repositoryItemCheckEdit4.CheckStyle = DevExpress.XtraEditors.Controls.CheckStyles.Style1;
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.repositoryItemLookUpEdit3.DisplayMember = "UC003";
			this.repositoryItemLookUpEdit3.Name = "repositoryItemLookUpEdit3";
			this.repositoryItemLookUpEdit3.NullText = "";
			this.repositoryItemLookUpEdit3.ValueMember = "UC001";
			// 
			...
			this.Size = new System.Drawing.Size(1646, 590);
        ...
        private DevExpress.XtraBars.BarEditItem bi_begin;
        private DevExpress.XtraEditors.Repository.RepositoryItemDateEdit repositoryItemDateEdit1;
        private DevExpress.XtraBars.BarStaticItem barStaticItem3;
        private DevExpress.XtraBars.BarEditItem bi_end;
        ...
        private DevExpress.XtraEditors.LabelControl lc_fs_je;
        private DevExpress.XtraEditors.LabelControl labelControl17;
        private DevExpress.XtraEditors.LabelControl labelControl18;
        private DevExpress.XtraEditors.LabelControl lc_fs_ps;
        private DevExpress.XtraEditors.LabelControl labelControl20;
        private DevExpress.XtraEditors.LabelControl lc_zs_je;
        private DevExpress.XtraEditors.LabelControl labelControl15;
        private DevExpress.XtraEditors.LabelControl labelControl13;
        private DevExpress.XtraEditors.LabelControl lc_zs_ps;
        private DevExpress.XtraEditors.LabelControl labelControl11;
        private DevExpress.XtraEditors.LabelControl lc_zf_je;
        private DevExpress.XtraEditors.LabelControl labelControl10;
        private DevExpress.XtraEditors.LabelControl labelControl8;
        private DevExpress.XtraEditors.LabelControl lc_zf_ps;
        private DevExpress.XtraEditors.LabelControl labelControl6;
        private DevExpress.XtraEditors.LabelControl labelControl5;
        private DevExpress.XtraEditors.LabelControl lc_total_je;
        private DevExpress.XtraEditors.LabelControl labelControl3;
        private DevExpress.XtraEditors.LabelControl lc_total_ps;
        ...
        private DevExpress.XtraGrid.Columns.GridColumn gridColumn_jshj;
        ...
        private DevExpress.XtraGrid.Columns.GridColumn gridColumn_jshj2;
        ...
        private DevExpress.XtraGrid.Columns.GridColumn gridColumn_jshj3;
        ...
        private DevExpress.XtraBars.BarEditItem bi_only;
