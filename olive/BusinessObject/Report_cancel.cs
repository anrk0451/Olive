...
{
    public partial class Report_cancel : BaseBusiness
    {
        public Report_cancel()
        {
            InitializeComponent();
        }
        /// <summary>
        ...
        {
            Frm_report_tombCancel frm_1 = new Frm_report_tombCancel();
            if(frm_1.ShowDialog() == DialogResult.OK)
            {
                string s_criteria = " AC003 LIKE '" + frm_1.swapdata["ac003"].ToString() + "' and " + 
                                    "FA200>= #" + frm_1.swapdata["dbegin"].ToString() + "# and FA200< #" + frm_1.swapdata["dend"].ToString() + "#";
