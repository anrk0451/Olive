namespace olive
{
    partial class Frm_main
    {
        ...
        private void InitializeComponent()
        {
			...
			this.ribbon.Size = new System.Drawing.Size(1370, 171);
			this.ribbon.StatusBar = this.ribbonStatusBar;
			// 
			// barButtonItem1
			// 
			this.barButtonItem1.Caption = "购墓登记";
			...
			// barButtonItem2
			// 
			this.barButtonItem2.Caption = "原始购墓登记";
			...
			// barButtonItem3
			// 
			this.barButtonItem3.Caption = "已售墓业务";
			...
			// barButtonItem4
			// 
			this.barButtonItem4.Caption = "收费日查询";
			...
			// barButtonItem5
			// 
			this.barButtonItem5.Caption = "财务综合统计";
			...
			// barButtonItem6
			// 
			this.barButtonItem6.Caption = "收款员统计";
			...
			// barButtonItem7
			// 
			this.barButtonItem7.Caption = "收费作废查询";
			...
			// barButtonItem8
			// 
			this.barButtonItem8.Caption = "墓位预订";
			...
			// barButtonItem9
			// 
			this.barButtonItem9.Caption = "操作员管理";
			...
			// barButtonItem10
			// 
			this.barButtonItem10.Caption = "权限分配";
			...
			// barButtonItem11
			// 
			this.barButtonItem11.Caption = "数据项目维护";
			...
			// barButtonItem12
			// 
			this.barButtonItem12.Caption = "收费项目维护";
			...
			// barButtonItem13
			// 
			this.barButtonItem13.Caption = "墓区结构维护";
			...
			// barButtonItem14
			// 
			this.barButtonItem14.Caption = "税票基本信息";
			...
			// barButtonItem15
			// 
			this.barButtonItem15.Caption = "税票项目维护";
			...
			this.barButtonItem16.SuperTip = superToolTip1;
			// 
			// barButtonItem17
			// 
			this.barButtonItem17.Caption = "角色管理";
			...
			// barButtonItem18
			// 
			this.barButtonItem18.Caption = "墓位预定查询";
			...
			// barButtonItem19
			// 
			this.barButtonItem19.Caption = "服务祭品";
			...
			// barButtonItem20
			// 
			this.barButtonItem20.Caption = "墓区数据";
			...
			// barButtonItem21
			// 
			this.barButtonItem21.Caption = "退墓数据";
			...
			// barButtonItem22
			// 
			this.barButtonItem22.Caption = "弃墓数据";
			...
			// barButtonItem25
			// 
			this.barButtonItem25.Alignment = DevExpress.XtraBars.BarItemLinkAlignment.Right;
			this.barButtonItem25.Caption = "当前版本:";
			...
			this.barButtonItem26.ImageOptions.SvgImage = global::olive.Properties.Resources.bo_security_permission;
			...
			// barButtonItem27
			// 
			this.barButtonItem27.Caption = "墓位销售统计";
			...
			this.ribbonPageGroup2.Text = "财务查询统计";
			// 
			// ribbonPageGroup3
			// 
			...
			this.ribbonStatusBar.Size = new System.Drawing.Size(1370, 29);
			// 
			// xtraTabControl1
			// 
			...
			this.xtraTabControl1.Location = new System.Drawing.Point(0, 171);
			this.xtraTabControl1.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.xtraTabControl1.Name = "xtraTabControl1";
			this.xtraTabControl1.SelectedTabPage = this.xtraTabPage1;
			this.xtraTabControl1.Size = new System.Drawing.Size(1370, 451);
			...
			this.xtraTabPage1.Size = new System.Drawing.Size(1368, 417);
			...
			this.pictureEdit1.EditValue = global::olive.Properties.Resources.cover;
			...
			this.pictureEdit1.Size = new System.Drawing.Size(1368, 417);
