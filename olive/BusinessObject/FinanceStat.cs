...
namespace olive.BusinessObject
{
	public partial class FinanceStat : BaseBusiness
	{
		...
		private OracleDataAdapter gserviceAdapter =
			new OracleDataAdapter("select sa004,sa003,sum(nums) nums,sum(sa007) sa007,sa025,sum(taxfee) taxfee from v_report_goodService where to_char(fa200,'yyyy-mm-dd') between :begin and :end group by sa004,sa003,sa025", SqlAssist.conn);
		...
		private void FinanceStat_Load(object sender, EventArgs e)
		{
			...
			gridView1.GroupSummary.Add(DevExpress.Data.SummaryItemType.Count, "RG003");
			gridView1.GroupSummary.Add(DevExpress.Data.SummaryItemType.Sum, "AC022");
			gridView1.GroupSummary[1].DisplayFormat = "金额合计:{0:n2}";
		...
		private void barButtonItem31_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
		{
			...
			{
				using (FinStat_report0 report = new FinStat_report0())
				{
